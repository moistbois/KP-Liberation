...
Respawn_truck_typename = ["B_LINGOR_Unimog_Transport", "rhsgref_hidf_rhib", "B_LINGOR_CH_34D"];                           // This is the mobile respawn (and medical) truck.
huron_typename = "vn_b_wheeled_m54_01";                                       // This is Spartan 01, a multipurpose mobile respawn as a helicopter.
...
KP_liberation_little_bird_classname = "B_LINGOR_M151A1_Transport";                  // These are the little birds which spawn on the Freedom or at Chimera base.
KP_liberation_boat_classname = "B_LINGOR_Datsun_Transport";                 // These are the boats which spawn at the stern of the Freedom.
...
support_vehicles = [
    ...
    [(Respawn_truck_typename select 1),200,0,100],
	[(Respawn_truck_typename select 2),200,0,100],
